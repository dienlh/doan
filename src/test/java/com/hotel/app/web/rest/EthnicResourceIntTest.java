...
public class EthnicResourceIntTest {
    ...
    public void initTest() {
        ...
        ethnic.setCreate_date(DEFAULT_CREATE_DATE);
    }
    ...
    public void createEthnic() throws Exception {
        ...
        assertThat(testEthnic.getCreate_date()).isEqualTo(DEFAULT_CREATE_DATE);
    }
    ...
    public void updateEthnic() throws Exception {
        ...
        ethnic.setCreate_date(UPDATED_CREATE_DATE);
        ...
        assertThat(testEthnic.getCreate_date()).isEqualTo(UPDATED_CREATE_DATE);
    }
