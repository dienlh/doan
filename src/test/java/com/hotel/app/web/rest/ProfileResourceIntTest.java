...
public class ProfileResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_SALARY_SUBSIDIES = new BigDecimal(0);
    private static final BigDecimal UPDATED_SALARY_SUBSIDIES = new BigDecimal(1);

    private static final BigDecimal DEFAULT_SALARY_BASIC = new BigDecimal(0);
    private static final BigDecimal UPDATED_SALARY_BASIC = new BigDecimal(1);
    ...
    @Test
    @Transactional
    public void checkSalary_subsidiesIsRequired() throws Exception {
        int databaseSizeBeforeTest = profileRepository.findAll().size();
        // set the field null
        profile.setSalary_subsidies(null);
    ...
    @Test
    @Transactional
    public void checkSalary_basicIsRequired() throws Exception {
        int databaseSizeBeforeTest = profileRepository.findAll().size();
        // set the field null
        profile.setSalary_basic(null);
