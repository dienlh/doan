...
public class RoomResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_HOURLY_PRICE = new BigDecimal(0);
    private static final BigDecimal UPDATED_HOURLY_PRICE = new BigDecimal(1);

    private static final BigDecimal DEFAULT_DAILY_PRICE = new BigDecimal(0);
    private static final BigDecimal UPDATED_DAILY_PRICE = new BigDecimal(1);
    ...
    public void initTest() {
        ...
        room.setHourly_price(DEFAULT_HOURLY_PRICE);
    ...
    public void createRoom() throws Exception {
        ...
        assertThat(testRoom.getHourly_price()).isEqualTo(DEFAULT_HOURLY_PRICE);
    ...
    @Test
    @Transactional
    public void checkNumber_of_livingroomIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setNumber_of_livingroom(null);
    ...
    @Test
    @Transactional
    public void checkNumber_of_bedroomIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setNumber_of_bedroom(null);
    ...
    @Test
    @Transactional
    public void checkNumber_of_toiletIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setNumber_of_toilet(null);
    ...
    @Test
    @Transactional
    public void checkNumber_of_kitchenIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setNumber_of_kitchen(null);
    ...
    @Test
    @Transactional
    public void checkNumber_of_bathroomIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setNumber_of_bathroom(null);
    ...
    @Test
    @Transactional
    public void checkMax_adultsIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setMax_adults(null);
    ...
    @Test
    @Transactional
    public void checkMax_kidsIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setMax_kids(null);
    ...
    @Test
    @Transactional
    public void checkHourly_priceIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setHourly_price(null);
    ...
    @Test
    @Transactional
    public void checkDaily_priceIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setDaily_price(null);
    ...
    @Test
    @Transactional
    public void checkMonthly_priceIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setMonthly_price(null);
    ...
    public void getAllRooms() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].hourly_price").value(hasItem(DEFAULT_HOURLY_PRICE.intValue())))
    ...
    public void getRoom() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms/{id}", room.getId()))
            ...
            .andExpect(jsonPath("$.hourly_price").value(DEFAULT_HOURLY_PRICE.intValue()))
    ...
    public void updateRoom() throws Exception {
        ...
        room.setHourly_price(UPDATED_HOURLY_PRICE);
        ...
        assertThat(testRoom.getHourly_price()).isEqualTo(UPDATED_HOURLY_PRICE);
