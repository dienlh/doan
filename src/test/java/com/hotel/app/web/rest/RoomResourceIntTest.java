...
public class RoomResourceIntTest {
    ...
    public void initTest() {
        ...
        room.setIsPet(DEFAULT_IS_PET);
        room.setIsBedKid(DEFAULT_IS_BED_KID);
        ...
        room.setMaxAdults(DEFAULT_MAX_ADULTS);
        room.setMaxKids(DEFAULT_MAX_KIDS);
    ...
    public void createRoom() throws Exception {
        ...
        assertThat(testRoom.getIsPet()).isEqualTo(DEFAULT_IS_PET);
        assertThat(testRoom.getIsBedKid()).isEqualTo(DEFAULT_IS_BED_KID);
        ...
        assertThat(testRoom.getMaxAdults()).isEqualTo(DEFAULT_MAX_ADULTS);
        assertThat(testRoom.getMaxKids()).isEqualTo(DEFAULT_MAX_KIDS);
    ...
    @Test
    @Transactional
    public void checkIsPetIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setIsPet(null);
    ...
    @Test
    @Transactional
    public void checkIsBedKidIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setIsBedKid(null);
    ...
    public void getAllRooms() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].isPet").value(hasItem(DEFAULT_IS_PET.booleanValue())))
                .andExpect(jsonPath("$.[*].isBedKid").value(hasItem(DEFAULT_IS_BED_KID.booleanValue())))
                ...
                .andExpect(jsonPath("$.[*].maxAdults").value(hasItem(DEFAULT_MAX_ADULTS)))
                .andExpect(jsonPath("$.[*].maxKids").value(hasItem(DEFAULT_MAX_KIDS)))
    ...
    public void getRoom() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms/{id}", room.getId()))
            ...
            .andExpect(jsonPath("$.isPet").value(DEFAULT_IS_PET.booleanValue()))
            .andExpect(jsonPath("$.isBedKid").value(DEFAULT_IS_BED_KID.booleanValue()))
            ...
            .andExpect(jsonPath("$.maxAdults").value(DEFAULT_MAX_ADULTS))
            .andExpect(jsonPath("$.maxKids").value(DEFAULT_MAX_KIDS))
    ...
    public void updateRoom() throws Exception {
        ...
        room.setIsPet(UPDATED_IS_PET);
        room.setIsBedKid(UPDATED_IS_BED_KID);
        ...
        room.setMaxAdults(UPDATED_MAX_ADULTS);
        room.setMaxKids(UPDATED_MAX_KIDS);
        ...
        assertThat(testRoom.getIsPet()).isEqualTo(UPDATED_IS_PET);
        assertThat(testRoom.getIsBedKid()).isEqualTo(UPDATED_IS_BED_KID);
        ...
        assertThat(testRoom.getMaxAdults()).isEqualTo(UPDATED_MAX_ADULTS);
        assertThat(testRoom.getMaxKids()).isEqualTo(UPDATED_MAX_KIDS);
