...
public class EmployeeResourceIntTest {
    ...
    private static final LocalDate DEFAULT_IDENTITY_CARD_NUMBER_PROV_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_IDENTITY_CARD_NUMBER_PROV_DATE = LocalDate.now(ZoneId.systemDefault());
    private static final String DEFAULT_IDENTITY_CARD_NUMBER_PROV_ADD = "AAAAA";
    private static final String UPDATED_IDENTITY_CARD_NUMBER_PROV_ADD = "BBBBB";
    ...
    public void initTest() {
        ...
        employee.setPhone_number(DEFAULT_PHONE_NUMBER);
        employee.setHomephone(DEFAULT_HOMEPHONE);
        employee.setIdentity_card_number(DEFAULT_IDENTITY_CARD_NUMBER);
        employee.setIdentity_card_number_prov_date(DEFAULT_IDENTITY_CARD_NUMBER_PROV_DATE);
        employee.setIdentity_card_number_prov_add(DEFAULT_IDENTITY_CARD_NUMBER_PROV_ADD);
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getIdentity_card_number_prov_date()).isEqualTo(DEFAULT_IDENTITY_CARD_NUMBER_PROV_DATE);
        assertThat(testEmployee.getIdentity_card_number_prov_add()).isEqualTo(DEFAULT_IDENTITY_CARD_NUMBER_PROV_ADD);
    ...
    @Test
    @Transactional
    public void checkIdentity_card_number_prov_dateIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setIdentity_card_number_prov_date(null);
    ...
    @Test
    @Transactional
    public void checkIdentity_card_number_prov_addIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setIdentity_card_number_prov_add(null);
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].identity_card_number_prov_date").value(hasItem(DEFAULT_IDENTITY_CARD_NUMBER_PROV_DATE.toString())))
                .andExpect(jsonPath("$.[*].identity_card_number_prov_add").value(hasItem(DEFAULT_IDENTITY_CARD_NUMBER_PROV_ADD.toString())))
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.identity_card_number_prov_date").value(DEFAULT_IDENTITY_CARD_NUMBER_PROV_DATE.toString()))
            .andExpect(jsonPath("$.identity_card_number_prov_add").value(DEFAULT_IDENTITY_CARD_NUMBER_PROV_ADD.toString()))
    ...
    public void updateEmployee() throws Exception {
        ...
        employee.setPhone_number(UPDATED_PHONE_NUMBER);
        employee.setHomephone(UPDATED_HOMEPHONE);
        employee.setIdentity_card_number(UPDATED_IDENTITY_CARD_NUMBER);
        employee.setIdentity_card_number_prov_date(UPDATED_IDENTITY_CARD_NUMBER_PROV_DATE);
        employee.setIdentity_card_number_prov_add(UPDATED_IDENTITY_CARD_NUMBER_PROV_ADD);
        ...
        assertThat(testEmployee.getIdentity_card_number_prov_date()).isEqualTo(UPDATED_IDENTITY_CARD_NUMBER_PROV_DATE);
        assertThat(testEmployee.getIdentity_card_number_prov_add()).isEqualTo(UPDATED_IDENTITY_CARD_NUMBER_PROV_ADD);
