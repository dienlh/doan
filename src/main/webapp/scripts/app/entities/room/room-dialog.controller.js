...
angular.module('hotelApp').controller('RoomDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Room', 'Type_room', 'Image', 'Amenity', 'Currency', 'Status_room', 'User',
        function($scope, $stateParams, $uibModalInstance, entity, Room, Type_room, Image, Amenity, Currency, Status_room, User) {
