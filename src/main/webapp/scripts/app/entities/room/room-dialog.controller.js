...
angular.module('hotelApp').controller('RoomDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Room', 'Kind', 'Image', 'Funiture', 'Currency', 'Status_room', 'User',
        function($scope, $stateParams, $uibModalInstance, entity, Room, Kind, Image, Funiture, Currency, Status_room, User) {

        $scope.room = entity;
        $scope.kinds = Kind.query();
        $scope.images = Image.query();
        $scope.funitures = Funiture.query();
