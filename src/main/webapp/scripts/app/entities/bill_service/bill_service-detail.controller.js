...
angular.module('hotelApp')
    .controller('Bill_serviceDetailController', function ($scope, $rootScope, $stateParams, entity, Bill_service, Currency, Services, Reservation, Status_bill_service, User) {
