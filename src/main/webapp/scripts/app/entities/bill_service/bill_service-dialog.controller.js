...
angular.module('hotelApp').controller('Bill_serviceDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Bill_service', 'Currency', 'Services', 'Reservation', 'Status_bill_service', 'User',
        function($scope, $stateParams, $uibModalInstance, entity, Bill_service, Currency, Services, Reservation, Status_bill_service, User) {
