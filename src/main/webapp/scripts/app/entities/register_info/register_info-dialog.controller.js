...
angular.module('hotelApp').controller('Register_infoDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Register_info', 'Currency', 'Room', 'Customer', 'Method_payment', 'Status_payment', 'Method_register', 'Status_register', 'User', 'Reservation',
        function($scope, $stateParams, $uibModalInstance, entity, Register_info, Currency, Room, Customer, Method_payment, Status_payment, Method_register, Status_register, User, Reservation) {
