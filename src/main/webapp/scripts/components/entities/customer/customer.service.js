        ...
        return $resource('api/customers/:id', {}, {
            ...
            'get': {
                ...
                transformResponse: function (data) {
                    ...
                    data.ic_passport_prov_date = DateUtils.convertLocaleDateFromServer(data.ic_passport_prov_date);
            ...
            'update': {
                ...
                transformRequest: function (data) {
                    data.ic_passport_prov_date = DateUtils.convertLocaleDateToServer(data.ic_passport_prov_date);
