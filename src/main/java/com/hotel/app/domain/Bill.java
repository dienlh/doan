...
public class Bill implements Serializable {
    ...
    public Long getFees_total() {
        return fees_total;
    }

    public void setFees_total(Long fees_total) {
