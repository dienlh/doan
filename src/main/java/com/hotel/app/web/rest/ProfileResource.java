...
import com.hotel.app.service.ProfileExcelBuilder;
...
public class ProfileResource {
	...
	@RequestMapping(value = "/profiles/exportExcel", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ModelAndView exportExcel(
		...
		List<Profile> profiles = profileService.findByMultiAttrWithRanger(positionId, departmentId, statusId,
				full_name,LocalDate.parse(fromDate), LocalDate.parse(toDate));
		return new ModelAndView(new ProfileExcelBuilder(), "lists",profiles);
	}
}
