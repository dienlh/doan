...
public class EventServiceImpl implements EventService {
	...
	@Override
	@Transactional(readOnly = true)
	public Page<Event> findAllByRangerDateAndStatus(Pageable pageable, LocalDate fromDate, LocalDate toDate,
			Long statusId) {
		Page<Event> events = eventRepository.findAllByRangerDateAndStatus(pageable, fromDate, toDate, statusId);
		return events;
	}
	@Override
	public Page<Event> findAllByStatusId(Pageable pageable, Long statusId) {
		Page<Event> events = eventRepository.findAllByStatusId(pageable, statusId);
		return events;
	}
